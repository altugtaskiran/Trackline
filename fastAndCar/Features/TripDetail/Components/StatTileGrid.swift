...
struct StatTileGrid: View {
    ...
    private var tiles: [StatTile] {
        var result: [StatTile] = []
        result.append(StatTile(title: "Top Speed", value: distanceUnit.speedString(kph: stats.topSpeedKph), icon: "speedometer", tint: Color(hex: 0xFF3B30)))
        result.append(StatTile(title: "Average Speed", value: distanceUnit.speedString(kph: stats.averageSpeedKph), icon: "gauge.medium", tint: Color(hex: 0xFF9100)))
        result.append(StatTile(title: "Distance", value: distanceUnit.distanceString(meters: stats.distanceMeters), icon: "point.topleft.down.curvedto.point.bottomright.up", tint: AppColor.accent))
        ...
        result.append(StatTile(title: "Highest Altitude", value: distanceUnit.altitudeString(meters: stats.highestAltitude), icon: "arrow.up.to.line", tint: Color(hex: 0xBF5AF2)))
        result.append(StatTile(title: "Lowest Altitude", value: distanceUnit.altitudeString(meters: stats.lowestAltitude), icon: "arrow.down.to.line", tint: Color(hex: 0x64D2FF)))
        result.append(StatTile(title: "Elevation Gain", value: distanceUnit.altitudeString(meters: stats.elevationGainMeters), icon: "arrow.up.right", tint: Color(hex: 0x34C759)))
        result.append(StatTile(title: "Elevation Loss", value: distanceUnit.altitudeString(meters: stats.elevationLossMeters), icon: "arrow.down.right", tint: Color(hex: 0xFF6482)))
        ...
        result.append(StatTile(title: "GPS Accuracy", value: "±" + distanceUnit.altitudeString(meters: stats.averageGpsAccuracy), icon: "location.fill", tint: Color(hex: 0x8E8E93)))
